...
local objects = {}
local themes = {
	Background = Color3.fromRGB(48, 0, 48), 
	Glow = Color3.fromRGB(25, 0, 55), 
	Accent = Color3.fromRGB(20, 0, 20), 
	LightContrast = Color3.fromRGB(40, 0, 40), 
	DarkContrast = Color3.fromRGB(155, 0, 155),  
